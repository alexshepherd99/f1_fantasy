...
# 2026 team - primary
#SEASON = 2026
#TEAM_START_DRIVERS = ["RUS@MER", "LIN@VRB", "COL@ALP", "BOR@AUD", "HAD@RED"]  # Starting line-up
#TEAM_START_CONSTRUCTORS = ["HAA", "MER"]  # Starting line-up
TEAM_START_DRIVERS = ["ANT@MER", "LIN@VRB", "BOR@AUD", "HAD@RED", "BEA@HAA"]
TEAM_START_CONSTRUCTORS = ["VRB", "MER"]
STARTING_RACE = 3
STARTING_UNUSED_BUDGET = 1.9

# 2026 team - secondary
SEASON = 2026
#TEAM_START_DRIVERS = ["BOR@AUD", "BOT@CAD", "HAD@RED", "LIN@VRB", "STR@AST"]  # Starting line-up
#TEAM_START_CONSTRUCTORS = ["MER", "MCL"]  # Starting line-up
#TEAM_START_DRIVERS = ["BOR@AUD", "BEA@HAA", "HAD@RED", "LIN@VRB", "ANT@MER"]
#TEAM_START_CONSTRUCTORS = ["MER", "VRB"]
#STARTING_RACE = 2
#STARTING_UNUSED_BUDGET = 1.5
