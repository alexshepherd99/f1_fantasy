...
TEAM_START_DRIVERS = ["ANT@MER", "BOT@CAD", "COL@ALP", "OCO@HAA", "LAW@VRB"]
TEAM_START_CONSTRUCTORS = ["MER", "FER"]
STARTING_RACE = 7
...
#TEAM_START_DRIVERS = ["SAI@WIL", "COL@ALP", "LAW@VRB", "OCO@HAA", "BOT@CAD"]
#TEAM_START_CONSTRUCTORS = ["MER", "FER"]
#STARTING_RACE = 6
#STARTING_UNUSED_BUDGET = 3.5
