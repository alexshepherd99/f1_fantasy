...
#TEAM_START_DRIVERS = ["ANT@MER", "BOT@CAD", "COL@ALP", "OCO@HAA", "PER@CAD"]
#TEAM_START_CONSTRUCTORS = ["MER", "FER"]
#STARTING_RACE = 5
#STARTING_UNUSED_BUDGET = 0.9
...
TEAM_START_DRIVERS = ["SAI@WIL", "COL@ALP", "LAW@VRB", "OCO@HAA", "PER@CAD"]
TEAM_START_CONSTRUCTORS = ["MER", "FER"]
STARTING_RACE = 5
STARTING_UNUSED_BUDGET = 1.0
