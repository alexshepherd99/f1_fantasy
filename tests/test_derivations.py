...
def test_derivation_tot_constructor():
    df_input = pd.DataFrame(
        ...
        data=[
            ...
            [2024, 1, "MER", -20, 2.0, 0, np.nan, np.nan, 0, np.nan, np.nan, np.nan, np.nan],  # negative points on first race
            [2024, 2, "MER", 30, 4.0, -20, 2.0, -10.0, -20, 2.0, -10.0, -200.0, -200.0],
            [2024, 3, "MER", 60, 6.0, 10, 6.0, 1.6667, 10, 6.0, 1.6667, 16.6667, 16.6667],  # different PPM
            [2024, 4, "MER", 60, 8.0, 70, 12.0, 5.8333, 90, 10.0, 9.0, 408.3333, 810.0],
